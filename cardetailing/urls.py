...
urlpatterns = [
    ...
    path("accounts/signup/submit/",booking_views.signup_submit,name="signup_submit",),
    ...
    path("bookings/create/submit/",booking_views.create_booking_submit,name="create_booking_submit",),
    path("bookings/<int:pk>/edit/", booking_views.edit_booking, name="edit_booking"),
    path("bookings/<int:pk>/edit/submit/",booking_views.edit_booking_submit,name="edit_booking_submit",),
    path("bookings/<int:pk>/delete/", booking_views.delete_booking, name="delete_booking"),
    path("bookings/<int:pk>/delete/confirm/",booking_views.delete_booking_confirm,name="delete_booking_confirm",),
